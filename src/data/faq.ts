...
export const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "You can acquire USDX through the official USDX platform, or through supported exchanges and decentralized protocols across our supported blockchain networks.",
    icon: "globe",
  },
  {
